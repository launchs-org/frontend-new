  ...
  return (
    <aside className="flex flex-col w-60 shrink-0 bg-white border-r border-gray-200 h-screen sticky top-0 overflow-y-auto">
      ...
      <div className="px-3 py-3 border-t border-gray-100">
        <button
          onClick={onLogout}
          className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-red-500 hover:bg-red-600 active:bg-red-700 text-white text-sm font-medium transition-all"
        >
